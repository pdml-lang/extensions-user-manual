...
-]
            ...
            [tr [tc [b PML Markup Code]][tc [link url=https://github.com/pdml-lang/extensions-user-manual]]]
        ]
    ]
    ...
    [u:ins-file path=02_syntax_extensions/index.pml]
    [u:ins-file path=03_parser_extensions/index.pml]
    [u:ins-file path=04_extension_nodes/index.pml]
    [u:ins-file path=05_PDML_XML_bridge/index.pml]
[-
    [u:ins-file path=06_history.pml]
-]
]
